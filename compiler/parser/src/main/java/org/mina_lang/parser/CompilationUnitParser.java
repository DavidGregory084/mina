...
public class CompilationUnitParser {
    ...
    public static CompilationUnitNode parse(TextDocumentItem document, SyntaxNodeCollector collector,
    ...
    public static CompilationUnitNode parse(String source, SyntaxNodeCollector collector,
            ANTLRErrorListener errorListener) {
        var charStream = CharStreams.fromString(source);
        return parse(charStream, collector, errorListener);
    }

    public static CompilationUnitNode parse(CharStream charStream, SyntaxNodeCollector collector,
            ANTLRErrorListener errorListener) {
    ...
    private static class CompilationUnitVisitor extends Visitor<CompilationUnitNode> {
        private SyntaxNodeCollector collector;

        public CompilationUnitVisitor(SyntaxNodeCollector collector) {
    ...
    private static class ModuleVisitor extends Visitor<ModuleNode> {
        ...
        public ModuleVisitor(SyntaxNodeCollector collector) {
            this.collector = collector;
        }
    ...
    private static class ImportVisitor extends Visitor<ImportNode> {
        ...
        public ImportVisitor(SyntaxNodeCollector collector) {
            this.collector = collector;
        }
    ...
    private static class DeclarationVisitor extends Visitor<DeclarationNode> {
        ...
        public DeclarationVisitor(SyntaxNodeCollector collector) {
            this.collector = collector;
        }
    ...
    private static class ExprVisitor extends Visitor<ExprNode> {
        ...
        public ExprVisitor(SyntaxNodeCollector collector) {
            this.collector = collector;
        }
    ...
    private static class MatchCaseVisitor extends Visitor<CaseNode> {
        ...
        public MatchCaseVisitor(ExprVisitor exprVisitor, SyntaxNodeCollector collector) {
    ...
    private static class PatternVisitor extends Visitor<PatternNode> {
        ...
        public PatternVisitor(SyntaxNodeCollector collector) {
            this.collector = collector;
        }
    ...
    private static class FieldPatternVisitor extends Visitor<FieldPatternNode> {
        ...
        public FieldPatternVisitor(SyntaxNodeCollector collector, PatternVisitor patternVisitor) {
            this.collector = collector;
    ...
    private static class QualifiedIdVisitor extends Visitor<QualifiedIdNode> {
        ...
        public QualifiedIdVisitor(SyntaxNodeCollector collector) {
            this.collector = collector;
        }
